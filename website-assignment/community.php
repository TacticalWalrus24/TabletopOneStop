...
<html>
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Table top gaming community and store">
        <meta name="keywords" content="Dungeons and Dragons, Pathfinder, table top gaming, dice, minis, DnD, D&D">
        <meta name="author" content="Vaughan Bunt">
            ...
            <nav>
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-1">
                        <ul class="navigation">
                            <li class="current-page"><a href="community.php">Community</a></li>
